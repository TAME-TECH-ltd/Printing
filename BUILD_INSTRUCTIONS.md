# Tame Print Agent - Build Instructions

## Overview

This document provides comprehensive instructions for building the Tame Print Agent application for Windows, including automated builds via GitHub Actions and local builds.
...
- **Files**:
  - `TamePrintAgent-Setup-1.2.2.exe` - NSIS installer
  - `TamePrintAgent-Portable-1.2.2.exe` - Portable executable
...
```
dist/
├── TamePrintAgent-Setup-1.2.2.exe    # Windows installer
├── TamePrintAgent-Portable-1.2.2.exe # Portable version
...
- [Project Repository](https://github.com/tameapps/tame-print-agent)
