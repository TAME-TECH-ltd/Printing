...
git clone https://github.com/tameapps/tame-print-agent.git
cd tame-print-agent
...
### **SQLite Database**
- **Location:** `~/.config/tame-print-agent/printing.sqlite`
...
```bash
# Fork the repository
git clone https://github.com/your-username/tame-print-agent.git
cd tame-print-agent
...
- **Issues:** [GitHub Issues](https://github.com/tameapps/tame-print-agent/issues)
- **Discussions:** [GitHub Discussions](https://github.com/tameapps/tame-print-agent/discussions)
- **Documentation:** [Wiki](https://github.com/tameapps/tame-print-agent/wiki)
...
**Built with ❤️ by Tame Apps Team**
