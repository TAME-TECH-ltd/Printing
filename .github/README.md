# GitHub Actions for Tame Print Agent

This repository includes automated build workflows for the Tame Print Agent application.
...
- Select "Build Optimized Tame Print Agent"
- Click "Run workflow"
...
### Windows
- `tame-print-agent-windows-optimized`: Optimized build without ffmpeg
- Installer: `.exe` or `.msi` files

### macOS
- `tame-print-agent-macos`: macOS application
- Package: `.dmg` files

### Linux
- `tame-print-agent-linux`: Linux application
